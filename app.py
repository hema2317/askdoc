...
def analyze_trends(current_user=None):
    try:
        ...
        for entry in symptoms:
            ...
            trend_input += f"- {date}: {issue} → {symptom} | Severity: {severity}/10 | Status: {status}\n"
...
Please generate a health trend summary in 4-6 bullet points:
- Identify patterns or recurring symptoms
- Mention if the condition seems improving or worsening
- Suggest if medical attention is advised
- Offer AI-generated tips (like hydration, rest, etc.)

Avoid repeating the full input. Make it easy for the user to understand.
"""
        ...
        print("AI trend summary error:", e)
